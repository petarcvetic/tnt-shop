	...
	function createNewInput(i,id_magacina){
		...
		if (predhodniArtikal != ""){ // ako predhodni input nije prazan izpisuje se novi input
			...
			var cell5 = '<input type="text" class="center-text input-small" onblur="calculateSum()" name="tezina'+i+'" id="tezina'+i+'" size="5" placeholder="tezina" required>';
			var cell6 = '<input type="text" class="center-text input-small" onblur="calculateSum()" name="broj-paketa'+i+'" id="broj-paketa'+i+'" size="3" placeholder="paketi" required>';
