...
if (isset($_GET['t'])){
	...
	elseif($zahtev == "editKorisnika"){ //AUTOFILL KORISNIKA U settings.php
...
//	$trenutna_godina = "2020";
	...
	if($godina == $trenutna_godina){ //nije doslo do promene godine
...
//			echo "<br> NEMA ZAPOCETE FAKTURE, zapocinje se nova br. " . $brojFakture;
	...
	else{// Ako se godina poslednje fakture i trenutna godina ne poklapaju broj fakture se pretvara u "1" a dodatak broju u trenutnu godinu
