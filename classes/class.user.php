      ...
      if($username != "" && $password != "") {
        try {
          ...
          if($count = 1 && !empty($row)) {
            ...
            $count_korisnika = $stmt->rowCount();
            $korisnik_row = $stmt->fetch(PDO::FETCH_ASSOC);

            if($count_korisnika = 1 && !empty($korisnik_row)){
              ...
              $_SESSION['sess_korisnik_status'] = 0;
              $_SESSION['error_msg'] = "Vasa firma vise nije korisnik ove aplikacije";
            }
